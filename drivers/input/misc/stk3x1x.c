...
inline uint32_t stk_alscode2lux(struct stk3x1x_data *ps_data, uint32_t alscode)
{
	...
	alscode /= ps_data->als_transmittance;
     /*wangjing@uni_drv modify lux value for elephone to turn up LCD light begin*/
	#if defined (UNISCOPE_DRIVER_L500_C_ELEPHONE)
	    return alscode*80;
	#else
	    //kangyan@uni_drv 20150630 add lux value
	    return alscode*30;
	#endif
     /*wangjing@uni_drv modify lux value for elephone to turn up LCD light end*/
}
...
//kangyan modify for suit 8916L version
