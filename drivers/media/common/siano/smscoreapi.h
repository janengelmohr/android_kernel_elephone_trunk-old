...
#define UNISCOPE_SMS_STATIC_MEM		  //zhongxiao@uniscope 20141103 for cant malloc 128k memory
...
#define DBG_INFO 1
#define DBG_ADV  2
#define UNISCOPE_DTV_DEBUG 1  //liguowei@uniscope 20140801 open dtv debug
...
#define  HOST_SMS_RSET_PIN (GPIO13 | 0x80000000)
//#define  HOST_SMS_POWER_IO_PIN (GPIO80 | 0x80000000)
//#define  HOST_SMS_POWER_EMI_PIN (GPIO62 | 0x80000000)
#define  HOST_SMS_POWER_IO_LDO
#define  HOST_SMS_POWER_EMI_LDO
#define  HOST_SMS_POWER_CORE_PIN (GPIO82 | 0x80000000)
...
#define gpio_direction_output(pin,level) 0
/*
