...
//	sms_err("sdio%d\n",board_id);
	...
	if (func->num == 1)
	{
//		sms_err("smssdio_probe 222 sdio_func_0");
...
//	sms_err("smssdio_remove11");

	smsdev = sdio_get_drvdata(func);
//	sms_err("smssdio_remove 22");
	sdio_claim_host(func);
//	sms_err("smssdio_remove33");

	sdio_release_irq(func);
//	sms_err("smssdio_remove44");
	sdio_disable_func(func);
//	sms_err("smssdio_remove55");
	sdio_release_host(func);
//	sms_err("smssdio_remove66");
